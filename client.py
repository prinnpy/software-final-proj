...
def usage():
    ...
    print("IRC simple Python client | by Group 5\n")
    print("$ python3 client.py USERNAME CHANNEL\n")
    print("where: USERNAME - your username, CHANNEL - channel you'd like to join (eg. channelname or #channelname)")

def channel(channel):
    """change input into channel format for freenode"""
    if channel.startswith("#") == False:
        return "#" + channel
    return channel

def print_response():
    """Helper function to help with thread target"""
